function generate_data(saveRoot)
...
%   saveRoot/combined
    ...
    % ------------------------------------------------------------
    combinedTrainFile = fullfile(combinedRoot, 'train.mat');
    combinedValidFile = fullfile(combinedRoot, 'valid.mat');
    combinedTestFile  = fullfile(combinedRoot, 'test.mat');
